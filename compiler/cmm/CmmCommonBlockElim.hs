...
hash_block block =
  ...
  where hash_fst _ h = h
        ...
        hash_node (CmmSwitch e _ _) = hash_e e
...
eqLastWith eqBid (CmmSwitch e1 signed1 ids1) (CmmSwitch e2 signed2 ids2) =
  e1 == e2 && signed1 == signed2 && eqSwitchTargetWith eqBid ids1 ids2
